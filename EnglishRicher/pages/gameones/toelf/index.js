...
Page({
  ...
  onLoad: function (options) {
    midArray = findLongestArray(wx.getStorageSync('toelfOneList'),'toelfOneList', wx.getStorageSync('toelfOneTwoList'), 'toelfOneTwoList', wx.getStorageSync('toelfOneThreeList'), 'toelfOneThreeList');
    // 显示正在刷新提示框
    wx.showToast({
      title: '努力加载中……',
      icon: 'loading',
